...
class MyWindow(QtWidgets.QMainWindow):
    ...
    def bind_buttons(self):
        ...
        self.ui.ls_add_button.clicked.connect(
            lambda: self.line_processing())
        self.ui.cutter_add_button.clicked.connect(lambda: self.clipper_processing())
    ...
    def clipper_processing(self):
        start = Point(self.ui.cutter_xmin_sb.value(),
                      self.ui.cutter_ymin_sb.value())
        end = Point(self.ui.cutter_xmax_sb.value(),
                    self.ui.cutter_ymax_sb.value())
        self.ui.canvas.add_clipper(start, end)
